...
const Benefits = () => {
  const benefits = [
    {
      ...
      description: "Cut fraud-related losses by up to 85% with our proactive security measures that prevent attacks before they succeed.",
      metric: "85%",
    ...
    },
    {
      ...
      description: "Automated threat detection and response reduces incident handling time from days to minutes.",
      metric: "98%",
      metricLabel: "Faster Response",
    },
    {
      icon: <UserCheck className="h-10 w-10 text-cyber-teal" />,
      title: "Enhance User Trust",
      description: "Build customer confidence with frictionless security that works invisibly to protect their accounts and data.",
      metric: "76%",
  ...
  const testimonials = [
    {
      quote: "DarkWave dramatically reduced our fraud incidents while improving our customer experience. The behavioral biometrics feature is a game-changer.",
      author: "Sarah Chen",
      title: "CISO at GlobalTech Solutions",
    },
    {
      quote: "After implementing DarkWave's solution, we saw immediate results. Our security team can now focus on strategic initiatives instead of constantly fighting fires.",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-foreground/80">
            Our solution doesn't just improve security—it delivers measurable
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto pt-4 flex items-end justify-between">
                  ...
                  <div className="h-16 w-24">
                    <div className="h-full w-full bg-gradient-to-t from-cyber-blue/20 to-transparent rounded-md relative overflow-hidden">
                      <div className="absolute bottom-0 left-0 right-0 cyber-gradient h-4/5 rounded-md animate-pulse-slow"></div>
                    </div>
                  </div>
                </div>
              </div>
